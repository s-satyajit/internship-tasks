...
// const navItems = ["Search", "List your venue", "Login"];
...
//           >
//             <p className="text-red-500 "><span className="font-bold text-2xl">mandap</span>.com</p>
//             <p className="">from Matrimonony.com group</p>
//           </Typography>
...
const Header = () => {
  return (
    <div className="container mx-auto px-6 shadow-lg shadow-black">
